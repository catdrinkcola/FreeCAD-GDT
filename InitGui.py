...
class GeometricDimensioningAndTolerancingWorkbench(Workbench):
    Icon = 'D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/GDT.svg'
    MenuText = 'GD&T'
    ...
    def Initialize(self):
        ...
        FreeCADGui.addIconPath('D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons')
        FreeCADGui.addPreferencePage('D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/ui/preferences-gdt.ui', 'GDT')
