...
def plotStrings(self, fp, points):
    ...
    if fp.GT != []:
        for i in range(len(fp.GT)):
            ...
            filename = filename.replace('D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons', iconPath)
...
class _ViewProviderGDT:
    ...
    def getIcon(self):
        ...
        return("D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/GDT.svg")
...
class _ViewProviderAnnotationPlane(_ViewProviderGDT):
    ...
    def getIcon(self):
        return("D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/annotationPlane.svg")
...
class _ViewProviderDatumFeature(_ViewProviderGDT):
    ...
    def getIcon(self):
        return("D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/datumFeature.svg")
...
class _ViewProviderDatumSystem(_ViewProviderGDT):
    ...
    def getIcon(self):
        return("D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/datumSystem.svg")
...
class _ViewProviderAnnotation(_ViewProviderGDT):
    ...
    def getIcon(self):
        return("D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/annotation.svg")
...
def makeFeatureControlFrame(toolTip=None):
    Label = ['','','','','','','','']
    Icon = ['', 'D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/FeatureControlFrame/freeState.svg', 'D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/FeatureControlFrame/leastMaterialCondition.svg', 'D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/FeatureControlFrame/maximumMaterialCondition.svg', 'D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/FeatureControlFrame/projectedToleranceZone.svg', 'D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/FeatureControlFrame/regardlessOfFeatureSize.svg', 'D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/FeatureControlFrame/tangentPlane.svg', 'D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/FeatureControlFrame/unequalBilateral.svg']
...
class GDTWidget:
    ...
    def activate( self, idGDT=0, dialogTitle='GD&T Widget', dialogIconPath='D:/Program Files/FreeCAD 0.19/Mod/FreeCAD-GDT/Gui/Resources/icons/GDT.svg', endFunction=None, dictionary=None):
...
class textLabelWidget:
    ...
    def generateWidget( self, idGDT, ContainerOfData ):
        ...
        if self.Dictionary == None:
            ...
            if NumberOfObjects > len(list(self.Dictionary))-1:
                NumberOfObjects = len(list(self.Dictionary))-1
            self.lineEdit.setText(list(self.Dictionary)[NumberOfObjects])
            self.text = list(self.Dictionary)[NumberOfObjects]
